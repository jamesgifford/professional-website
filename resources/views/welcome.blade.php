        ...
        <main>
            ...
            <section class="min-h-svh flex items-center px-6">
                <div class="mx-auto max-w-5xl w-full py-32">
                    ...
                    <div class="mt-16 font-mono text-xs text-zinc-400 dark:text-zinc-600 flex items-center gap-3 bg-zinc-50/80 dark:bg-zinc-950/80 backdrop-blur-md rounded-lg px-3 py-1.5 w-fit">
            ...
            <section id="contact" class="px-6 py-24 sm:py-32 border-t border-zinc-200 dark:border-zinc-800">
                <div class="mx-auto max-w-5xl">
                    <div class="grid lg:grid-cols-12 gap-12 lg:gap-16">
                        <div class="lg:col-span-4">
                            <p class="font-mono text-xs text-emerald-600 dark:text-emerald-400 mb-2 tracking-wide bg-zinc-50/80 dark:bg-zinc-950/80 backdrop-blur-md rounded-lg px-3 py-1.5 w-fit">// contact</p>
                            <h2 class="text-3xl font-semibold tracking-tight bg-zinc-50/80 dark:bg-zinc-950/80 backdrop-blur-md rounded-lg px-3 py-1.5 w-fit">Let's Connect</h2>
                        </div>
                        <div class="lg:col-span-8">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="mailto:james@jamesgifford.com"
                                   class="font-mono text-sm inline-flex items-center gap-2 px-5 py-2.5 rounded border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 text-zinc-600 dark:text-zinc-400 hover:border-zinc-400 dark:hover:border-zinc-600 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
