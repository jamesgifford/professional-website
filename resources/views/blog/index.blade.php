<x-layouts::public title="Thoughts" metaDescription="Thoughts on software, engineering, and building things by James Gifford." canonicalUrl="{{ route('blog.index') }}">
    <section class="px-6 py-16 sm:py-24">
        <div class="mx-auto max-w-5xl">
            <div class="mb-12">
                <p class="font-mono text-xs text-emerald-600 dark:text-emerald-400 mb-2 tracking-wide bg-zinc-50/80 dark:bg-zinc-950/80 backdrop-blur-md rounded-lg px-3 py-1.5 w-fit">// thoughts</p>
                <h1 class="text-4xl font-semibold tracking-tight bg-zinc-50/80 dark:bg-zinc-950/80 backdrop-blur-md rounded-lg px-3 py-1.5 w-fit">Thoughts</h1>
                <p class="mt-3 text-zinc-500 dark:text-zinc-400 bg-zinc-50/80 dark:bg-zinc-950/80 backdrop-blur-md rounded-lg px-3 py-1.5 w-fit">On software, engineering, and building things.</p>
            </div>
